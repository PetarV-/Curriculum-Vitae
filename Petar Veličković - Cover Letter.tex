...
\newcommand{\closing}[3]{%
\vspace{2em}
{#1} \hfill \\[5em] % Space for signature
...
\node[anchor=north west, rectangle, text width=\paperwidth, text badly centered, text height=3.75em, text depth=5.5em, fill=white] (nd) at (current page.north west) 
{\textcolor{maincolour}{
	% Name
	...
	\includegraphics[width=1em]{assets/search-homepage-blue.eps} & {\href{http://petar-v.com}{\tt petar-v.com}} & \includegraphics[width=1em]{assets/GitHub-Mark-Blue.eps} & 
	{\href{https://github.com/PetarV-}{\tt github.com/PetarV-}} & \includegraphics[width=1em]{assets/In-Blue-2in-TM.eps} & {\href{https://uk.linkedin.com/in/petarvelickovic}{\tt uk.linkedin.com/in/petarvelickovic}}
	\end{tabular}}
	}
};
\draw[line width=0.5mm, maincolour] (nd.south west) -- (nd.south east);
\draw[line width=0.2pt, maincolour] ([yshift=-0.16em]nd.south west) -- ([yshift=-0.16em]nd.south east);
\end{tikzpicture}
...
\sendtwimc{Trinity College \\ University of Cambridge}{\today}
