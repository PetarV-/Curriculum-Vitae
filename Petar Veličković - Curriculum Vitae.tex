...
\fillbar{2.19}{2.6}{2016--present} & \mainitem{Cambridge Coding Academy}{Machine Learning Tutor}{Cambridge, United Kingdom}{}
\sitemize{%
	\sitem Developing educational online resources on machine learning, teaching and delivering tech talks
	\sitem {\tt https://cambridgecoding.com/course/machine-learning}
} \vspace{-\baselineskip}\mbox{}
\\[5pt]
