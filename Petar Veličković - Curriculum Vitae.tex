...
{\textcolor{white}{
	...
	\includegraphics[width=1em]{assets/search-homepage.eps} & {\href{http://petar-v.com}{\tt petar-v.com}} & \includegraphics[width=1em]{assets/GitHub-Mark.eps} & 
...
\fillbar{2.19}{2.6}{2016--present} & \mainitem{Trinity College, University of Cambridge} {Doctor of Philosophy (PhD), Machine Learning and Bioinformatics}{Cambridge, United Kingdom}{} 
\sitemize{%
...
\fillbar{1.16}{2.19}{2012--2015} & \mainitem{Trinity College, University of Cambridge} {Bachelor of Arts (BA Hons.\ (Cantab.)), Computer Science}{Cambridge, United Kingdom}{} 
...
\sitemize{%
	\sitem Results:
		...
		\vspace{-0.7em}
		\begin{tabbing}	
			\hspace{0.5em}--\hspace{0.2em} Part IA\=:\ \= Class I (mark 283\=/375, rank 1\=0/83)\\
			\hspace{0.5em}--\hspace{0.2em} Part IB\>:\> Class I (mark 302\>/400, rank 1\=3/80)\\
			\hspace{0.5em}--\hspace{0.2em} Part II\>:\> Class I (mark 312\>/400, rank \>9/74)
...
\fillbar{0}{1.16}{2008--2012} & \mainitem{Matemati\v{c}ka gimnazija}{Mathematical Grammar School}{Belgrade, Serbia}{}
...
\fillbar{2.6}{2.6}{Jul--Sep 2017} & \mainitem{Universit\'{e} de Montr\'{e}al}{Visiting Researcher}{Montr\'{e}al, Canada}{}
\sitemize{%
	\sitem Montr\'{e}al Institute for Learning Algorithms (MILA)
} \vspace{-\baselineskip}\mbox{}
\\[5pt]

\fillbar{2.19}{2.6}{2016--present} & \mainitem{University of Cambridge}{Research Assistant in Computational Biology}{Cambridge, United Kingdom}{}
\sitemize{%
	\sitem Computer Laboratory | Artificial Intelligence Group
} \vspace{-\baselineskip}\mbox{}
\\[5pt]

\fillbar{2.19}{2.6}{2016--present} & \mainitem{Cambridge Spark}{Machine Learning Tutor}{Cambridge, United Kingdom}{}
\sitemize{%
	\sitem Developing educational online resources on machine learning, teaching and delivering tech talks
	\sitem {\tt https://cambridgespark.com/courses/machine-learning}
} \vspace{-\baselineskip}\mbox{}
\\[5pt]

\fillbar{2.45}{2.52}{Jul--Oct 2016} & \mainitem{Nokia Bell Labs}{Research Associate}{Cambridge, United Kingdom}{}
\sitemize{%
	\sitem Deep learning for massive-scale medical time series data analysis
} \vspace{-\baselineskip}\mbox{}
\\[5pt]

% I'm breaking the cvtable here to force partial content on a new page.
}

\cvtable{%

\fillbar{1.885}{1.978}{Jun--Sep 2015} & \mainitem{Jane Street Europe Limited}{Software Developer Intern}{London, United Kingdom}{New York, United States}
...
\fillbar{1.315}{1.377}{Jun--Aug 2014} & \mainitem{University of Cambridge}{Undergraduate Researcher}{Cambridge, United Kingdom}{} 
\sitemize{%
...
\fillbar{1.045}{1.138}{Jun--Sep 2013} & \mainitem{Microsoft Development Center Serbia}{Intern Software Design Engineer}{Belgrade, Serbia}{}
...
\mytilde{December 2016} & \pubitem{X-CNN: Cross-modal convolutional neural networks for sparse datasets}{\textbf{Veli\v{c}kovi\'{c}, P.}, Wang, D., Lane, ND. and Li\`{o}, P.}{The 7$^\text{th}$ IEEE Symposium Series in Computational Intelligence (IEEE SSCI 2016)}
\\[5pt]

\mytilde{June 2016} & \pubitem{Viral: Real-world competing process simulations on multiplex networks}{\textbf{Veli\v{c}kovi\'{c}, P.}, Iva\v{s}kovi\'{c}, A., Lau, S. and Stanojevi\'{c}, M.}{The 1$^\text{st}$ Belgrade Bioinformatics Conference (BelBi 2016)}
\\[5pt]

\mytilde{April 2016} & \pubitem{muxstep: an open-source C++ multiplex HMM library\newline for making inferences on multiple data types}{\textbf{Veli\v{c}kovi\'{c}, P.} and Li\`{o}, P.}{Bioinformatics, doi:10.1093/bioinformatics/btw196}
\\[5pt]

\mytilde{December 2015} & \pubitem{Molecular multiplex network inference\newline using Gaussian mixture hidden Markov models}{\textbf{Veli\v{c}kovi\'{c}, P.} and Li\`{o}, P.}{Journal of Complex Networks, doi:10.1093/comnet/cnv029}
}
...
\stars{5}{5}{Proficient} & C/\CC, C$^\sharp$, Python, Java, OCaml, Keras, TensorFlow, \LaTeX, PGF/Ti\emph{k}Z, \texttt{git}, \textsc{Unix}\newline Algorithms, Data Structures, Machine Learning, Bioinformatics, Teaching
\\[5pt]
