...
\mytilde{October 2015} & \pubitem{Molecular multiplex network inference\newline using Gaussian mixture hidden Markov models}{\textbf{Veli\v{c}kovi\'{c}, P.} and Li\`{o}, P.}{Journal of Complex Networks (in press)}
}
